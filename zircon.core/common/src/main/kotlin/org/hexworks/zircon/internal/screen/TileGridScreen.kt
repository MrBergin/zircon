...
import org.hexworks.zircon.internal.behavior.impl.CompositeLayerStateHolder
...
class TileGridScreen(
        ...
        private val componentContainer: CompositeComponentContainer =
                buildCompositeContainer(tileGrid.size, tileGrid.tileset),
        private val bufferGrid: InternalTileGrid = ThreadSafeTileGrid(
                initialSize = tileGrid.size,
                initialTileset = tileGrid.tileset,
                layerable = CompositeLayerStateHolder(
                        layerable = ThreadSafeLayerable(tileGrid.size),
    ...
    companion object {
        ...
        private fun buildCompositeContainer(
                initialSize: Size,
                initialTileset: TilesetResource): CompositeComponentContainer {
